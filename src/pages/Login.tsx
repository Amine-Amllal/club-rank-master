...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        queryParams: {
          hd: "edu.umi.ac.ma", // Domain restriction
        },
      },
    });
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary via-primary/90 to-accent">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-card p-10 shadow-2xl">
        ...
        <div className="mt-8">
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            Only @edu.umi.ac.ma email addresses are permitted
          </p>
        </div>
      </div>
    </div>
